...
export class AsDetailCellValuePipe implements PipeTransform {
  transform(row: Record<string, any>, parentAttr: EntityAttributeDefinition, col: EntityAttributeDefinition, asDetailReferenceOptions: Record<string, Record<string, PersistentObject[]>>): string {
