...
@Component({
  ...
  imports: [CommonModule, RouterModule, BsAlertModule, BsButtonGroupComponent, BsCardModule, BsContainerComponent, BsGridModule, BsTableComponent, IconComponent, TranslateKeyPipe],
