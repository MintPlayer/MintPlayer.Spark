...
| [Dates & Sort Companions](docs/guide-dates-and-sorting.md) | ⚠️ *Planned, not yet implemented.* What you write for a `DateTimeOffset`, why `*Sort` companions are only for `[Search]` strings, and the sorting beliefs that measurement refuted |
